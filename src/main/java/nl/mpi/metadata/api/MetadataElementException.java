...
public class MetadataElementException extends MetadataDocumentException {
    ...
    public MetadataElementException(String message) {
	super(message);
    }

    public MetadataElementException(String message, Throwable cause) {
	super(message, cause);
    }

    public MetadataElementException(Throwable cause) {
	super(cause);
    }
